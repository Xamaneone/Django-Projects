...
tests = [
    ...
    ("http://url-decoder.com/name=Test%20Testov", "http://url-decoder.com/name=Test Testov"),
    ("http://url-decoder.com/name=Test+Testov", "http://url-decoder.com/name=Test Testov"),
